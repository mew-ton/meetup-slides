...
**英国の IT 意思決定者 500 名への年次調査 (Data Health Check 2026) より**

- **4 社に 1 社 (26%)** が過去 1 年にサプライチェーン発のインシデントを経験
- 約半数 (48%) は **リスクを認識しながら** 取引を継続
- 認識しながら放置した組織の被害率は **4 倍以上** (43% vs 10%)
- 「重要なサプライヤーは **自社と同じように扱う** 必要がある」
...
- ライブラリ依存の更新は即時に取り込まず, **数日置いてから** 上げる (cooldown 運用)
- CI では lockfile を固定 (`npm ci`) し, **Actions の権限設定も点検** する
- 一方, WordPress のような **基盤の緊急セキュリティパッチは即時適用** —
  「待つべき更新」と「今すぐ当てる更新」を使い分ける
- 「ツールが守ってくれるから安心」ではなく, **多層で守る** 前提を持つ
