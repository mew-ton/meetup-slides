...
- ※ 5 月号では「ES2026 に正式採用」と紹介していました. 訂正します 🙇
...
| ------------------------------ | ------------- | ----------- | ------- |
| `text-fit`                     | ✅ (150〜)    | ❌          | ❌      |
| `background-clip: border-area` | ✅ (150〜)    | ✅ (18.2〜) | ❌      |
| `focusgroup`                   | ✅ (150〜)    | ❌          | ❌      |

- `text-fit` / `focusgroup` は **Chromium 単独先行** (標準化は議論中)
- 文字サイズや枠線は, 非対応ブラウザでは **通常表示に落ちるだけ** → 段階的強化で使える
