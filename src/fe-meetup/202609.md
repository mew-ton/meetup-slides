...
- Google が運営する, Web 開発者向けの情報サイト
- 新しい Web 標準の解説や, 各ブラウザの対応状況をまとめて発信している
- Chrome チームによる告知の窓口の 1 つにもなっている
...
- Interop = ブラウザ間で挙動が違う機能を, **各社が 1 年かけて揃える** 取り組み
  (Apple / Google / Microsoft / Mozilla / Igalia が参加している)
- 9/3, web.dev / WebKit / Microsoft Edge のブログが同時に告知した
- **誰でも GitHub の Issue で提案できる**
- 条件は **成熟した Web 標準に基づくこと** と **テストで測れること** の 2 つ
...
**開設から 30 年. いまも更新が続いている**

- 1996/09/10 に「とほほの HTML 入門」として開設 → **2026/09/10 で満 30 年**
  (「とほほの WWW 入門」への改名は, 同じ年の 10/25)
- 目次には CGI / Perl / SSI と並んで,
  React / Next.js / Tailwind CSS / Docker / Kubernetes / OpenAI API が載る
- 管理人は 2025 年に本業を退職. その後も更新を続けている

<!-- _footer: "出典: [主な更新履歴 (とほほの WWW 入門)](https://www.tohoho-web.com/wwwhist.htm)" -->
