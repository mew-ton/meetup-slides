...
## "Apple / Google / Microsoft / Mozilla / Igalia" とは

- **Apple / Google / Microsoft / Mozilla** — Safari / Chrome / Edge / Firefox を開発する 4 社
- **Igalia** — ブラウザエンジンの開発を請け負う, スペインの企業
- この 5 者が, いま Web ブラウザの中身を実際に作っている当事者にあたる
...
- Interop = ブラウザ間で挙動が違う機能を, **この 5 者が 1 年かけて揃える** 取り組み
- 9/3, web.dev / WebKit / Microsoft Edge の各ブログが同時に告知した
